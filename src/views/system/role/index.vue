  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form ref="dataSearch" :inline="true" :model="listQuery.search">
        <el-input v-model="listQuery.search.title" :placeholder="$t('system.role.title')" class="filter-item" style="width: 200px;" clearable @keyup.enter.native="handleFilter" />
        <el-input v-model="listQuery.search.slug" :placeholder="$t('system.role.slug')" class="filter-item" style="width: 200px;" clearable @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column :label="$t('system.role.title')">
        <template slot-scope="scope">
          <span>{{ scope.row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('system.role.slug')">
        <template slot-scope="scope">
...
import { fetchList as fetchGroupList } from '@/api/system/group'
